...
export const contactHMTLTemplate = (emailInfo: EmailInfo): string => {
  ...
  * {
  ...
  <table id="u_content_text_11" style="font-family:arial,helvetica,sans-serif;" role="presentation" cellpadding="0" cellspacing="0" width="100%" border="0">
    ...
    <div style="line-height: 140%; text-align: left; word-wrap: break-word;">
      <p style="font-size: 14px; line-height: 140%; text-align: center;"><span style="font-size: 10px; line-height: 14px;">Email ricevuta da <a rel="noopener" href="https://www.niccolomantovani.com" target="_blank">niccolomantovani.com</a></span></p>
    </div>
...
export const contactTXTTemplate = (emailInfo: EmailInfo): string => {
  const text: string = `Ciao Niccolò, hai ricevuto un nuovo messaggio:\n\n
    ...
    - Messaggio: \n${emailInfo.message}\n\n
    email ricevuta da www.niccolomantovani.com`;
